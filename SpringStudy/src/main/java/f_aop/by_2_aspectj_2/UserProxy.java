...
public class UserProxy {
    ...
    //记住一定要在域的通配符后面用空格隔开！
    @After(value = "execution(* aop.by_2_aspectj_2.User.add(..))")
    public void after() {
        System.out.println("after...");
    }

    @AfterReturning(value = "execution(* aop.by_2_aspectj_2.User.add(..))")
    public void afterReturning() {
        System.out.println("AfterReturning...");
    }

    @Around(value = "execution(* aop.by_2_aspectj_2.User.add(..))")
